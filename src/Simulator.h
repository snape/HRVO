...
#ifndef HRVO_DIFFERENTIAL_DRIVE
/**
...
class HRVO_EXPORT Simulator {
 public:
   ...
   * @param[in] agentNo The number of the agent whose left wheel speed is to be
   *                    retrieved.
   ...
   *
   * @details   The preferred speed of an agent is the speed it would choose to
   *            take if it were not influenced by other agents.
   *
   ...
   * @param[in] agentNo The number of the agent whose progress towards its goal
   *                    is to be retrieved.
   ...
   * @param[in] agentNo The number of the agent whose right wheel speed is to be
   *                    be retrieved.
   ...
   *
   * @param[in] agentNo The number of the agent whose time to orientation is to
   *                    be retrieved.
   ...
   *            widened to allow for uncertainty in the position and velocity of
   *            a differential drive agent.
   *
   ...
   * @param[in] maxAccel          The default maximum
   * acceleration of a new agent.
   * @param[in] velocity          The default initial velocity of a new agent.
   * @param[in] orientation       The default initial orientation (in radians)
   *                              of a new agent.
   */
