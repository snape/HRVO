...
/**
 * \brief  Set to 0 for a holonomic agent; set to 1 for a differential-drive
 * agent.
 */
...
class HRVO_EXPORT Simulator {
 public:
   ...
   * agent. \return     The number of the agent.
   */
  std::size_t addAgent(const Vector2 &position, std::size_t goalNo,
  ...
  /**
   * \brief  Performs a simulation step; updates the orientation, position, and
   * velocity of each agent, and the progress of each towards its goal.
   */
  void doStep();

  /**
   * \brief      Returns the goal number of a specified agent.
   * \param[in]  agentNo  The number of the agent whose goal number is to be
   * retrieved. \return     The present goal number of the agent.
   */
   ...
   * retrieved. \return     The present goal radius of the agent
   */
   ...
   * \param[in]  agentNo  The number of the agent whose left wheel speed is to
   * be retrieved. \return     The present signed left wheel speed of the agent.
   */
   ...
   * to be retrieved. \return     The present maximum acceleration of the agent.
   */
   ...
   * is to be retrieved. \return     The present maximum neighbor count of the
   * agent.
   */
   ...
   * distance is to be retrieved. \return     The present maximum neighbor
   ...
   * retrieved. \return     The present orientation (in radians) of the agent.
   */
   ...
   * retrieved. \return     The present position of the (center of) the agent.
   */
   ...
   * retrieved. \return     The present radius of the agent.
   */
  float getAgentRadius(std::size_t agentNo) const;

  /**
   * \brief      Returns the progress towards its goal of a specified agent.
   * \param[in]  agentNo  The number of the agent whose progress towards its
   * goal is to be retrieved. \return     True if the agent has reached its
   ...
   * \param[in]  agentNo  The number of the agent whose right wheel speed is to
   * be retrieved. \return     The present signed right wheel speed of the
   * agent.
   */
   ...
   *
   * \param[in]  agentNo  The number of the agent whose time to orientation is
   * to be retrieved. \return     The present time to orientation of the agent.
   */
   ...
   *
   * \param[in]  agentNo  The number of the agent whose uncertainty offset is to
   * be retrieved. \return     The present uncertainty offset of the agent.
   */
   ...
   * retrieved. \return     The present velocity of the agent.
   */
   ...
   * \param[in]  agentNo  The number of the agent whose wheel track is to be
   * retrieved. \return     The present wheel track of the agent.
   */
   ...
   * \param[in]  goalNo  The number of the goal whose position is to be
   * retrieved. \return     The position of the goal.
   */
   ...
   * \param[in]  neighborDist       The default maximum neighbor distance of a
   * new agent. \param[in]  maxNeighbors       The default maximum neighbor
   * count of a new agent. \param[in]  radius             The default radius of
   * a new agent. \param[in]  goalRadius         The default goal radius of a
   * new agent. \param[in]  prefSpeed          The default preferred speed of a
   * new agent. \param[in]  maxSpeed           The default maximum speed of a
   * new agent. \param[in]  uncertaintyOffset  The default uncertainty offset of
   * a new agent. \param[in]  maxAccel           The default maximum
   * acceleration of a new agent. \param[in]  velocity           The default
   * initial velocity of a new agent. \param[in]  orientation        The default
   * initial orientation (in radians) of a new agent.
   */
   ...
   * \param[in]  agentNo  The number of the agent whose goal number is to be
   * modified. \param[in]  goalNo   The replacement goal number.
   */
   ...
   * \param[in]  agentNo   The number of the agent whose maximum acceleration is
   * to be modified. \param[in]  maxAccel  The replacement maximum acceleration.
   */
   ...
   * \param[in]  agentNo       The number of the agent whose maximum neighbor
   * count is to be modified. \param[in]  maxNeighbors  The replacement maximum
   * neighbor count.
   */
   ...
   * \param[in]  agentNo       The number of the agent whose maximum neighbor
   * distance is to be modified. \param[in]  neighborDist  The replacement
   ...
   * \param[in]  agentNo      The number of the agent whose orientation is to be
   * modified. \param[in]  orientation  The replacement orientation (in
   * radians).
   */
   ...
   * \param[in]  agentNo   The number of the agent whose position is to be
   * modified. \param[in]  position  The replacement position.
   */
   ...
   *             to take if it were not influenced by other agents.
   *
   * \param[in]  agentNo    The number of the agent whose preferred speed is to
   * be modified. \param[in]  prefSpeed  The replacement preferred speed.
   */
   ...
   * \param[in]  agentNo  The number of the agent whose radius is to be
   * modified. \param[in]  radius   The replacement radius.
   */
   ...
   *             defined by its new velocity.
   *
   * \param[in]  agentNo            The number of the agent whose time to
   * orientation is to be modified. \param[in]  timeToOrientation  The
   * replacement time to orientation.
   */
   ...
   * \param[in]  agentNo     The number of the agent whose wheel track is to be
   * modified. \param[in]  wheelTrack  The replacement wheel track.
   */
   ...
   *             of a differential drive agent.
   *
   * \param[in]  agentNo            The number of the agent whose uncertainty
   * offset is to be modified. \param[in]  uncertaintyOffset  The replacement
   * uncertainty offset.
   */
   ...
   * \param[in]  agentNo   The number of the agent whose velocity is to be
   * modified. \param[in]  velocity  The replacement velocity.
   */
