...
class KdTree {
 private:
   ...
   * computed. \param[in]  rangeSq  The squared range around the agent.
   */
   ...
   * specified agent. \param[in]      agent    A pointer to the agent for which
   * neighbors are to be computed. \param[in,out]  rangeSq  The squared range
   * around the agent. \param[in]      node     The current k-D tree node.
   */
