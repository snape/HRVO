...
class HRVO_EXPORT Vector2 {
 public:
   ...
   * vector. \param[in]  other  The vector with which the dot product should be
   * computed. \return     The dot product of this vector with a specified
   * vector.
   */
   ...
   * specified scalar value. \param[in]  scalar  The scalar value with which the
   * scalar multiplication should be computed. \return     The scalar
   * multiplication of this vector with a specified scalar value.
   */
   ...
   * division should be computed. \return     The scalar division of this vector
   ...
   * vector. \param[in]  other  The vector with which the vector sum should be
   * computed. \return     The vector sum of this vector with a specified
   * vector.
   */
   ...
   * specified vector. \param[in]  other  The vector with which the vector
   * difference should be computed. \return     The vector difference of this
   * vector with a specified vector.
   */
  Vector2 operator-(const Vector2 &other) const {
    return Vector2(x_ - other.x_, y_ - other.y_);
  }
   ...
   * itself with the specified scalar value. \param[in]  scalar  The scalar
   * value with which the scalar multiplication should be computed. \return A
   ...
   * with the specified scalar value. \param[in]  scalar  The scalar value with
   * which the scalar division should be computed. \return     A reference to
   * this vector.
   */
  Vector2 &operator/=(float scalar) {
    const float invScalar = 1.0F / scalar;
   ...
   * sum should be computed. \return     A reference to this vector.
   */
   ...
   * itself with the specified vector. \param[in]  other  The vector with which
   * the vector difference should be computed. \return     A reference to this
   * vector.
   */
  Vector2 &operator-=(const Vector2 &other) {
    x_ -= other.x_;
 ...
 * x-axis. \param[in]  vector  The vector whose angle with the positive x-axis
 * is to be calculated. \return     The angle in radians between the vector and
 * the positive x-axis in the range [-PI, PI].
 */
 ...
 * of the specified vectors. \param[in]  vector1  The top row of the square
 * matrix. \param[in]  vector2  The bottom row of the square matrix. \return The
 ...
 * points. \param[in]  vector1  The first end point of the line segment.
 * \param[in]  vector2  The second end point of the line segment.
 * \return     The normal vector of the line segment.
 */
HRVO_EXPORT inline Vector2 normal(const Vector2 &vector1,
 ...
 * the specified scalar value. \param[in]  scalar  The scalar value with which
 * the scalar multiplication should be computed. \param[in]  vector  The vector
 * with which the scalar multiplication should be computed. \return     The
 * scalar multiplication of the vector with the scalar value.
 */
 ...
 * output stream. \param[in]  stream  The output stream into which the
 * two-dimensional vector should be inserted. \param[in]  vector  The
 * two-dimensional vector which to insert into the output stream. \return     A
